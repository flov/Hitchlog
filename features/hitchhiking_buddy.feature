Feature: Edit user
  ...
  Scenario: view buddy requests
    Given "Sarah" logged a future trip from "Cairns" to "Byron Bay" at the "21. December 2015"
     When I go to the hitchhiking buddies page
     Then I should see "Sarah wants to hitchhike from Cairns to Byron Bay at the 21 December 2015"
